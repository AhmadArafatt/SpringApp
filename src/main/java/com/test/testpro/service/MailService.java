...
public class MailService {
    ...
    private final String BASE_URL = "http://localhost:8080";//we can setup as configuration that get pass into this class
    ...
    public void sendEmailFromTemplate(User user, String templateName, String subject) {
        ...
        Context context = new Context(locale);//What we are going to send into email template
